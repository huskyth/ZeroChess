...
class CChessNNet(nn.Module):
    ...
    def __init__(self, args):
        ...
        self.conv1 = nn.Conv2d(1, out_channels=128, kernel_size=5, stride=1, padding=2)
        ...
        self.conv31 = nn.Conv2d(128, 128, 3, stride=1, padding=1)
        self.bn31 = nn.BatchNorm2d(128)
        self.conv32 = nn.Conv2d(128, 128, 3, stride=1, padding=1)
        self.bn32 = nn.BatchNorm2d(128)

        self.conv41 = nn.Conv2d(128, 128, 3, stride=1, padding=1)
        self.bn41 = nn.BatchNorm2d(128)
        self.conv42 = nn.Conv2d(128, 128, 3, stride=1, padding=1)
        self.bn42 = nn.BatchNorm2d(128)

        self.conv51 = nn.Conv2d(128, 128, 3, stride=1, padding=1)
        self.bn51 = nn.BatchNorm2d(128)
        self.conv52 = nn.Conv2d(128, 128, 3, stride=1, padding=1)
        self.bn52 = nn.BatchNorm2d(128)

        self.conv61 = nn.Conv2d(128, 128, 3, stride=1, padding=1)
        self.bn61 = nn.BatchNorm2d(128)
        self.conv62 = nn.Conv2d(128, 128, 3, stride=1, padding=1)
        self.bn62 = nn.BatchNorm2d(128)

        self.conv71 = nn.Conv2d(128, 128, 3, stride=1, padding=1)
        self.bn71 = nn.BatchNorm2d(128)
        self.conv72 = nn.Conv2d(128, 128, 3, stride=1, padding=1)
        self.bn72 = nn.BatchNorm2d(128)

        self.conv8_left = nn.Conv2d(128, 4, kernel_size=3, stride=1, padding=1)
        self.bn8_left = nn.BatchNorm2d(4)
        self.fc81_left = nn.Linear(360, 256)
        self.fc82_left = nn.Linear(256, 1)

        self.conv8_right = nn.Conv2d(128, 32, kernel_size=3, stride=1, padding=1)
