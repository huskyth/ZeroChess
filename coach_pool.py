...
from china_chess.algorithm.mcts_pool import *
...
class Coach:
    ...
    def execute_episode(self, iter_number):
        ...
        while True:
            ...
            move = self.mcts.get_move_probs(gs, temp=temp)
            pi = [0] * len(LABELS)
    ...
    def learn(self):
        ...
        for i in range(1, self.args.numIters + 1):
            ...
            pmcts = MCTS(net=self.pnet, name="p-mcts")
            self.nnet.train(trainExamples, i)
            nmcts = MCTS(net=self.nnet, name="n-mcts")
